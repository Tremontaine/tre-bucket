...
A scoop bucket for apps I use that doesn't exist in other buckets
...
To add this bucket, run `scoop bucket add tre-bucket https://github.com/Tremontaine/tre-bucket`. To install, do `scoop install <manifest>`.
